  ...
  return (
    <Pressable onPress={onEdit}>
      <View style={styles.card}>
        ...
        <Text style={[styles.value, !cleanValue(profile?.full_name) && styles.placeholder]}>
          {cleanValue(profile?.full_name) || 'Tap to add your name'}
        </Text>

        <Text style={styles.label}>University</Text>
        <Text style={[styles.value, !cleanValue(profile?.university_name) && styles.placeholder]}>
          {cleanValue(profile?.university_name) || 'Tap to add your university'}
        </Text>

        <Text style={styles.label}>Phone</Text>
        <Text style={[styles.value, !cleanValue(profile?.phone) && styles.placeholder]}>
